...
import net.picklepark.discord.command.HelpCommand;
import net.picklepark.discord.command.MakeAdminCommand;
import net.picklepark.discord.command.UnadminCommand;
